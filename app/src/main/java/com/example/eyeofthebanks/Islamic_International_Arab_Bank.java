...
public class Islamic_International_Arab_Bank extends AppCompatActivity {
    Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_islamic__international__arab__bank);
        intent = new Intent(getBaseContext(), sorry.class);
        intent.putExtra("image", "IIAB");
    }

    public void AMMAN(View view) {
        Intent intent = new Intent(getBaseContext(), amman_iiab.class);
        startActivity(intent);
    }

    public void Al_Mafraq(View view) {
        Intent intent = new Intent(getBaseContext(), mafraq_iiab.class);
        startActivity(intent);
    }

    public void Az_Zarqa(View view) {
        Intent intent = new Intent(getBaseContext(), az_zarqa_iiab.class);
        startActivity(intent);
    }

    public void Irbid(View view) {
        Intent intent = new Intent(getBaseContext(), irbid_iiab.class);
        startActivity(intent);
    }
    ...
    public void Ajlun(View view) {
        Intent intent = new Intent(getBaseContext(), ajlun_iiab.class);
        startActivity(intent);
    }

    public void Jarash(View view) {
        Intent intent = new Intent(getBaseContext(), jarash_iiab.class);
        startActivity(intent);
    }
    ...
    public void Al_Aqaba(View view) {
        Intent intent = new Intent(getBaseContext(), al_aqaba_iiab.class);
        startActivity(intent);
    }

    public void Maan(View view) {
        Intent intent = new Intent(getBaseContext(), maan_iiab.class);
        startActivity(intent);
    }
    ...
    public void WEBSITE(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://iiabank.com.jo/"));
        startActivity(intent);
    }

    public void Al_Balqa(View view) {
        Intent intent = new Intent(getBaseContext(), al_balqa_iiab.class);
        startActivity(intent);
